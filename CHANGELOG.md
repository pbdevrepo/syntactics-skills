...
- `engineering-workflow`: `sync-dev-tdd-stage` `agents/engineering/tdd-api-developer.md` - GREEN phase specialist for REST API endpoints (routes, controllers, request validation); for BE/FS sessions with dedicated route tasks
