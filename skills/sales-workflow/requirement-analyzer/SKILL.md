...
version: 1.0.0
description: >
  Entry point for the Sales workflow at Syntactics Inc. Analyzes client requirements from a PDF
  upload or free-form text and produces a structured requirements document. Trigger when a Sales
  team member says "analyze client requirements", "we have a new client", "I have client notes",
  "start the sales workflow", or shares any client brief, email, or RFP. Always run this skill
  first — before proposal-grill, proposal-writer, and quotation.
---
