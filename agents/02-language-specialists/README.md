...
### [**angular-architect**](angular-architect.md) - Angular 19+ enterprise patterns expert
...
### [**django-developer**](django-developer.md) - Django 5+ web development expert
...
Expert in modern PowerShell 7+, .NET 9/10 APIs, cross-platform scripting, CI/CD integration, and cloud automation using Az and Microsoft Graph.
